// Fitur 3: Notifikasi (Customer) — dengan auto-refresh 10 detik
...
export default function Notifications() {
  ...
  // FIX #1: tambah refetchInterval 10 detik agar notif baru langsung muncul
  ...
  const markAllMut = useMutation({
    ...
    onSuccess: () => {
      ...
      qc.invalidateQueries({ queryKey: ['notification-unread'] }); // update badge
          ...
          <div className="space-y-2">
            {notifications.map(n => (
              <button
                ...
                className={`w-full text-left card p-4 flex items-start gap-3 hover:shadow-md transition-shadow ${
                  !n.read_at
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-0.5 line-clamp-2">
                    {n.body || n.message || n.data?.message}
                  </p>
