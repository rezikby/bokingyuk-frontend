...
import { ArrowLeft, CalendarDays, Clock, MapPin, FileText, QrCode } from 'lucide-react';
...
export default function BookingDetail() {
  ...
  const b = data;
  const showQR = b?.qr_token && ['confirmed','checked_in'].includes(b?.status);
        ...
        <div className="space-y-4">
          ...
          {showQR && (
            <div className="card p-5 text-center">
              ...
              <div className="inline-block p-4 bg-white rounded-2xl border">
                <QRCodeSVG
